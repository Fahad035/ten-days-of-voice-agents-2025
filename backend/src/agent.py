...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - Fahad")
print("📚 SUBSCRIBE: https://www.youtube.com/@MdFahad-tp1dz/videos")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Fahad Cafe".
...
async def entrypoint(ctx: JobContext):
    ...
    print("📺 YouTube: https://www.youtube.com/@MdFahad-tp1dz")
...
if __name__ == "__main__":
    ...
    print("📺 SUBSCRIBE: https://www.youtube.com/@MdFahad-tp1dz")
    print("⚡" * 25 + "\n")
